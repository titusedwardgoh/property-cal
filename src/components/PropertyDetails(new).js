...
export default function PropertyDetailsNew({ formData, updateFormData }) {
            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <div className="max-w-md mx-auto">
                <input
                  ...
                  className="w-full px-8 py-6 text-4xl font-light text-center border-2 border-gray-200 rounded-2xl focus:border-gray-400 focus:outline-none transition-all duration-200 hover:border-gray-300"
                />
              </div>
            </div>
          </div>
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <div className="max-w-2xl mx-auto">
                <input
                  ...
                  className="w-full px-8 py-6 text-2xl font-light text-center border-2 border-gray-200 rounded-2xl focus:border-gray-400 focus:outline-none transition-all duration-200 hover:border-gray-300"
                />
              ...
              <div className="grid grid-cols-4 gap-6 max-w-2xl mx-auto">
                {['NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'NT', 'ACT'].map((state) => (
                  <button
                    ...
                    className={`px-6 py-4 text-xl font-medium rounded-2xl border-2 transition-all duration-200 text-center hover:scale-105 ${
              ...
              <div className="grid grid-cols-2 gap-6 max-w-3xl mx-auto">
                {[
                  ...
                  <button
                    ...
                    className={`p-8 rounded-2xl border-2 transition-all duration-200 text-center flex items-center justify-center hover:scale-105 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {[
                  ...
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 transition-all duration-200 text-center hover:scale-105 ${
  ...
  return (
    <div className="bg-base-100 rounded-2xl overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 md:relative md:bottom-auto md:left-auto md:right-auto bg-white md:bg-transparent border-t md:border-t-0 border-gray-200 md:border-gray-200 p-4 md:p-0 md:mt-8 md:px-6 md:pb-8">
