...
import { Receipt, ChevronDown, ChevronUp, MessageCircle } from 'lucide-react';
...
export default function OtherFees({
  ...
  if (!price || price <= 0) {
    return (
      <div className="space-y-6">
        {/* Other Things to Ask the Seller Card - Always visible but disabled */}
  ...
  return (
    <div className="space-y-6">
      {/* Other Things to Ask the Seller Card */}
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <MessageCircle className="w-5 h-5 text-purple-600" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  type="number"
                  value={councilRates ? Math.round(Number(councilRates)) : ''}
                  onChange={(e) => setCouncilRates(Number(e.target.value) || 0)}
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  type="number"
                  value={waterRates ? Math.round(Number(waterRates)) : ''}
                  onChange={(e) => setWaterRates(Number(e.target.value) || 0)}
                  className="w-24 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  placeholder="0"
                />
              </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              ...
              {includeBodyCorporate && (
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    type="number"
                    value={bodyCorporate ? Math.round(Number(bodyCorporate)) : ''}
                    onChange={(e) => setBodyCorporate(Number(e.target.value) || 0)}
                    className="w-24 px-2 py-1 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    placeholder="0"
                  />
                </div>
